      ...
      <div className={styles.container}>
        <div className={styles.left}>
          ...
          <div className={styles.ctaWrapper} style={{display:'flex',gap:18,marginBottom:32}}>
            <Link href="#download" className={styles.ctaPrimary} style={{background:'#123922',color:'#fff',fontWeight:600,fontSize:18,padding:'16px 32px',borderRadius:999,boxShadow:'0 10px 26px rgba(47,107,55,0.15)', display: 'flex', alignItems: 'center', gap: 12}}>
            ...
            <Link href="#buy" className={styles.ctaSecondary} style={{background:'#FFD86A',color:'#123922',fontWeight:600,fontSize:18,padding:'16px 32px',borderRadius:999,boxShadow:'0 10px 26px rgba(255,216,106,0.15)', display: 'flex', alignItems: 'center', gap: 12}}>
