    ...
    <section id="intro" className={styles.hero} aria-label="Hero">
      <div className={styles.container}>
        <div className={styles.left}>
          <span className={styles.badge} style={{background:'var(--gold)',color:'var(--text)',fontWeight:600,padding:'10px 18px',borderRadius:999,boxShadow:'0 8px 24px rgba(2,6,23,0.06)',fontSize:18,marginBottom:18,display:'inline-block'}}>Sigues el primer culer en descobrir-ho</span>
          ...
          <p className={styles.description} style={{fontSize:22,maxWidth:540,marginBottom:28}}>Descobreix els millors bars per veure els partits del FC Barcelona. Viu l'ambient, consulta els horaris i no et perdis cap gol amb troBar!</p>
          ...
          <div className={styles.ctaWrapper} style={{display:'flex',gap:18,marginBottom:32}}>
            <Link href="#download" className={styles.ctaPrimary} style={{background:'var(--accent)',color:'#fff',fontWeight:600,fontSize:18,padding:'16px 32px',borderRadius:999,boxShadow:'0 10px 26px var(--shadow)', display: 'flex', alignItems: 'center', gap: 12}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-start'}}>
                <span style={{fontSize: 12, fontWeight: 400, lineHeight: 1}}>Descarrega-la des de</span>
                <span style={{fontSize: 20, lineHeight: 1, marginTop: 4}}>l'App Store</span>
              </div>
            </Link>
            <Link href="#buy" className={styles.ctaSecondary} style={{background:'var(--blue)',color:'#fff',fontWeight:600,fontSize:18,padding:'16px 32px',borderRadius:999,boxShadow:'0 10px 26px var(--shadow)', display: 'flex', alignItems: 'center', gap: 12}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-start'}}>
                <span style={{fontSize: 12, fontWeight: 400, lineHeight: 1}}>DESCOBREIX L'APP A</span>
